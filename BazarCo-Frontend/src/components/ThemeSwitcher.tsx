  ...
  return (
    <div className="relative" ref={ref}>
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex items-center justify-center rounded-lg border border-[var(--brand-border)] bg-[var(--card-bg)] p-2 text-[var(--brand-white)] hover:bg-[var(--input-bg)] transition-colors"
