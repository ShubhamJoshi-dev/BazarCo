      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm rounded-2xl border border-[var(--brand-border)] bg-[var(--brand-black)] shadow-2xl overflow-hidden"
            ...
            <div className="p-6 text-center">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  onClick={onCancel}
                  disabled={loading}
                  className="flex-1 rounded-xl border border-[var(--brand-border)] bg-[var(--input-bg)] px-4 py-2.5 text-sm font-medium text-[var(--brand-white)] hover:bg-[var(--input-bg)] transition-colors disabled:opacity-60"
                >
                  Cancel
                </button>
                <button
