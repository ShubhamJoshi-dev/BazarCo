...
export default function CheckoutCancelledPage() {
  ...
  return (
    <motion.div
      ...
      className="max-w-md mx-auto rounded-2xl bg-[var(--card-bg)] p-8 text-center shadow-sm"
    >
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <Link
          ...
          className="inline-flex items-center rounded-xl border border-[var(--brand-border)] px-5 py-2.5 text-sm font-medium text-[var(--brand-white)] hover:bg-[var(--input-bg)]"
        >
